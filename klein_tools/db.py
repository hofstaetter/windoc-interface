...
class Queries:
    ...
    def all_Interns_with_comms(self, with_condition=None):
        ...
        query = "SELECT Stammdaten.Intern, Email, Telefon, Tel1, Tel2, Handy FROM Stammdaten LEFT JOIN Stammzusatz ON Stammdaten.Intern = Stammzusatz.Intern %s" % with_condition
